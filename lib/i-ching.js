...
class Reading {
  constructor(question) {
    ...
    // console.log('hexagram lines: %j', hexagramLines);
    // console.log('changing lines: %j', changingLines);
    ...
    function generateComposite(numStalks) {
      ...
      // console.log('left pile: %d, right pile: %d', leftPileSize, rightPileSize);
      let stalksUsed = 0;
      ...
      // console.log('stalks used: %d, composite number: %d', composite.stalksUsed, composite.number);
      ...
      function getRemainder(pileSize) {
        ...
        // console.log('pileSize: %d, remainder: %d', pileSize, r);
...
function initialize() {
  ...
  iChing.reading = function reading(question) {
